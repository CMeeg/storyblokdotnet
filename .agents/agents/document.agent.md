...
tools: ['read', 'search', 'edit', 'web/fetch', 'storyblok/search', 'storyblok/describe', 'io.github.upstash/context7/*', 'microsoftdocs/mcp/*']
...
- Create and update XML doc (triple-slash) comments in C# source files when needed for end-user clarity.
  - Use the `csharp-docs` skill when updating C# source files (`*.cs`).
